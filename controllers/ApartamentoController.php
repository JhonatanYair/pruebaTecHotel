...
class ApartamentoController extends Controller
{
    ...
    public function actionCreate()
    {
        ...
        if ($this->request->isPost) {
            ...
            Yii::$app->session->setFlash('success', 'Apartamento creado exitosamente.');
    ...
    public function actionUpdate($id)
    {
        ...
        if ($this->request->isPost && $model->load($this->request->post()) && $model->save()) {
            Yii::$app->session->setFlash('success', 'Apartamento editado exitosamente.');
            return $this->redirect(['view', 'id' => $model->id]);
        }
    ...
    public function actionDelete($id)
    {
        ...
        Yii::$app->session->setFlash('success', 'Apartamento eliminado exitosamente.');
    ...
    {
        if (($model = Apartamento::findOne(['id' => $id])) !== null) {
            return $model;
        }
